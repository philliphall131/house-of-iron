  ...
  return (
    <tr>
      ...
      <TableInput 
        ...
        disabled={!checked.is_reps}
      />
      <TableInput 
        name={`planned_weight`} 
        value={row.planned_weight} 
        updateRowData={updateRowData} 
        disabled={!checked.is_weight}
      />
      <TableInput 
        name={`planned_distance`} 
        value={row.planned_distance} 
        updateRowData={updateRowData} 
        disabled={!checked.is_distance}
      />
      <TableInput 
        name={`planned_time_secs`} 
        value={row.planned_time} 
        updateRowData={updateRowData} 
        disabled={!checked.is_time}
      />
    </tr>
  )
}
